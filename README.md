...
### `principalca`
Performs principal component analysis on a dataset to reduce dimensionality while retaining as much variance as possible.

### `pseudoinverse`
Computes the Moore-Penrose pseudoinverse of a matrix, useful for solving systems of linear equations that are not necessarily square or invertible.
